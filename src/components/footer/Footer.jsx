...
const Footer = () => {
  return (
    <footer>
      <a href="#home" className="footer__logo">Scroll Down Solutions</a>
      ...
      <a href="https://www.linkedin.com/in/scroll-down-solutions-09642927a/" target="_blank" rel="noreferrer" ><BsLinkedin /></a>
